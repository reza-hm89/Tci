<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Modal.aspx.cs" Inherits="Mngmnt_Modal" %>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea placeholder="توضیحات" id="txtDescription" class="form-control" rows="5"></textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group">
                            <input id="txtUrl" type="text" readonly="readonly" placeholder="آدرس فایل" class="form-control InputRequire uneditable-input ">
                ...
                <div class="form-group">
                    ...
                    <div id="DivSave" class="col-sm-4 col-sm-offset-2">
                        <button id="btnSaveModal" class="btn btn-blue  btn-block">
                            ثبت اطلاعات 
                        </button>
                    </div>
                </div>
