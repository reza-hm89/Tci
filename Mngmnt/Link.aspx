<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Link.aspx.cs" Inherits="Mngmnt_Link" %>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" placeholder=" لینک" id="txtLink" class="form-control InputRequire">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label ">
                ...
                <div class="form-group">
                    ...
                    <div id="DivSave" class="col-sm-4 col-sm-offset-2">
                        <button id="btnSaveLink" class="btn btn-blue  btn-block">
                            ثبت اطلاعات 
                        </button>
                    </div>
                </div>
