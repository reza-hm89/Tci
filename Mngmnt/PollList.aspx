<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PollList.aspx.cs" Inherits="Mngmnt_PollList" %>
...
<head>
    ...
    <script src="js/PollList.js"></script>
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">لیست نظرسنجی</li>
