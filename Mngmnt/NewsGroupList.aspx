<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewsGroupList.aspx.cs" Inherits="Mngmnt_NewsGroupList" %>
...
<head>
    ...
    <script src="js/NewsGroupList.js"></script>
</head>
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">گروه های خبری</li>
            ...
            <div id="divInsert" style="display: none">
                ...
                <div id="div1" class="form-group">
                    ...
                    <div id="DivSave" class="col-sm-2 col-sm-offset-1">
                        <button id="btnSaveNewsGroup" class="btn btn-blue  btn-block">
                            ثبت اطلاعات 
                        </button>
                    </div>
                </div>
