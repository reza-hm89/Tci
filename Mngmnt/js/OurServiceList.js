...
function SetVisibility(id, visibility) {
    ...
    $.ajax({
        type: "POST",
        url: "WebServices/OurServiceWs.asmx/SetVisibility",
...
function LoadOurService() {

    ShowLoading();

    $.ajax({
        type: "POST",
        url: "WebServices/OurServiceWs.asmx/GetData",
        data: "{}",
        contentType: "application/json; charset=utf-8",
        datatype: "jsondata",
        async: "true",
...
function bindRecordToEdit(id) {
    ...
    $("#container").load("OurService.aspx", function () {
        ...
        $("h1").text("ویرایش خدمات");

        $(".active").text("ویرایش خدمات");

        $("#btnSaveOurService").text("ثبت تغییرات");
        ...
        $.ajax({
            type: "POST",
            url: "WebServices/OurServiceWs.asmx/BindRecordToEdit",
            data: "{id:'" + id + "'}",
            contentType: "application/json; charset=utf-8",
            datatype: "jsondata",
            async: "true",
            success: function (response) {
                ...
                $("#txtPriority").val(msg[0].Priority);
...
function deleteRecord(id) {
    ...
    if (ans == true) {
        $.ajax({
            type: "POST",
            url: "WebServices/OurServiceWs.asmx/DeleteRecord",
            data: "{id:'" + id + "'}",
            contentType: "application/json; charset=utf-8",
            datatype: "jsondata",
            async: "true",
...
function deleteSelected(idList) {
    ...
    $.ajax({
        type: "POST",
        url: "WebServices/OurServiceWs.asmx/DeleteMultiRecord",
