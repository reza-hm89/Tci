...
function SetVisibility(id, visibility) {
    ...
    $.ajax({
        type: "POST",
        url: "WebServices/LanguageWs.asmx/SetVisibility",
...
function bindRecordToEdit(id) {
    ...
    $("#container").load("Language.aspx", function () {
        ...
        $(".active").text("ویرایش زبان");

        $("#btnSaveLanguage").text("ثبت تغییرات");
        ...
        $.ajax({
            type: "POST",
            url: "WebServices/LanguageWs.asmx/BindRecordToEdit",
            data: "{id:'" + id + "'}",
            contentType: "application/json; charset=utf-8",
            datatype: "jsondata",
            async: "true",
...
function deleteRecord(id) {
    ...
    if (ans == true) {
        $.ajax({
            type: "POST",
            url: "WebServices/LanguageWs.asmx/DeleteRecord",
            data: "{id:'" + id + "'}",
            contentType: "application/json; charset=utf-8",
            datatype: "jsondata",
            async: "true",
...
function deleteSelected(idList) {
    ...
    $.ajax({
        type: "POST",
        url: "WebServices/LanguageWs.asmx/DeleteMultiRecord",
