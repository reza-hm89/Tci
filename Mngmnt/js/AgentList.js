...
function SetVisibility(id, visibility) {
    ...
    $.ajax({
        type: "POST",
        url: "WebServices/AgentWs.asmx/SetVisibility",
...
function LoadAgent() {
    ...
    $.ajax({
        type: "POST",
        url: "WebServices/AgentWs.asmx/GetData",
        data: "{}",
        contentType: "application/json; charset=utf-8",
        datatype: "jsondata",
        async: "true",
...
function bindRecordToEdit(id) {
    ...
    $("#container").load("Agent.aspx", function () {
        ...
        $("h1").text("ویرایش نمایندگی");

        $(".active").text("ویرایش نمایندگی");

        $("#btnSaveAgent").text("ثبت تغییرات");
        ...
        $.ajax({
            type: "POST",
            url: "WebServices/AgentWs.asmx/BindRecordToEdit",
            data: "{id:'" + id + "'}",
            contentType: "application/json; charset=utf-8",
            datatype: "jsondata",
            async: "true",
            success: function (response) {
                ...
                $("#txtCompany").val(msg[0].Company);
                $("#txtCode").val(msg[0].Code);
                $("#txtActivity").val(msg[0].Activity);
...
function deleteRecord(id) {
    ...
    if (ans == true) {
        $.ajax({
            type: "POST",
            url: "WebServices/AgentWs.asmx/DeleteRecord",
            data: "{id:'" + id + "'}",
            contentType: "application/json; charset=utf-8",
            datatype: "jsondata",
            async: "true",
...
function deleteSelected(idList) {
    ...
    $.ajax({
        type: "POST",
        url: "WebServices/AgentWs.asmx/DeleteMultiRecord",
