...
function SetVisibility(id, visibility) {
    ...
    $.ajax({
        type: "POST",
        url: "WebServices/ModalWs.asmx/SetVisibility",
...
function LoadModal() {
    ...
    $.ajax({
        type: "POST",
        url: "WebServices/ModalWs.asmx/GetData",
        data: "{}",
        contentType: "application/json; charset=utf-8",
        datatype: "jsondata",
        async: "true",
...
function bindRecordToEdit(id) {
    ...
    $("#container").load("Modal.aspx", function () {
        ...
        $.ajax({
            type: "POST",
            url: "WebServices/ModalWs.asmx/BindRecordToEdit",
            data: "{id:'" + id + "'}",
            contentType: "application/json; charset=utf-8",
            datatype: "jsondata",
            async: "true",
...
function deleteRecord(id) {
    ...
    if (ans == true) {
        $.ajax({
            type: "POST",
            url: "WebServices/ModalWs.asmx/DeleteRecord",
            data: "{id:'" + id + "'}",
            contentType: "application/json; charset=utf-8",
            datatype: "jsondata",
            async: "true",
...
function deleteSelected(idList) {
    ...
    $.ajax({
        type: "POST",
        url: "WebServices/ModalWs.asmx/DeleteMultiRecord",
