...
function bindRecordToEdit(id) {
    ...
    $("#container").load("AuctionGroup.aspx", function () {
        ...
        $("#btnSaveAuctionGroup").text("ثبت تغییرات");
        ...
        $.ajax({
            type: "POST",
            url: "WebServices/AuctionGroupWs.asmx/BindRecordToEdit",
            data: "{id:'" + id + "'}",
            contentType: "application/json; charset=utf-8",
            datatype: "jsondata",
            async: "true",
...
function deleteRecord(id) {
    ...
    if (ans == true) {
        $.ajax({
            type: "POST",
            url: "WebServices/AuctionGroupWs.asmx/DeleteRecord",
            data: "{id:'" + id + "'}",
            contentType: "application/json; charset=utf-8",
            datatype: "jsondata",
            async: "true",
...
function deleteSelected(idList) {
    ...
    $.ajax({
        type: "POST",
        url: "WebServices/AuctionGroupWs.asmx/DeleteMultiRecord",
