...
function LoadIdea() {
    ...
    $.ajax({
        type: "POST",
        url: "../WebServices/IdeaWs.asmx/GetData",
        data: "{}",
...
function bindRecordToEdit(id) {
    ...
    $("#container").load("Idea.aspx", function () {

       
        $.ajax({
            type: "POST",
            url: "../WebServices/IdeaWs.asmx/BindRecordToEdit",
            data: "{id:'" + id + "'}",
            contentType: "application/json; charset=utf-8",
            datatype: "jsondata",
            async: "true",
            success: function (response) {
                ...
                $("#txtKind").val(msg[0].Kind);
                $("#txtIdea").val(msg[0].Idea);
                $("#txtDescription").val(msg[0].Description);
                $("#txtMobile").val(msg[0].Mobile);
                $("#txtAdvantage").val(msg[0].Advantage);
...
function deleteRecord(id) {
    ...
    if (ans == true) {
        $.ajax({
            type: "POST",
            url: "WebServices/IdeaWs.asmx/DeleteRecord",
            data: "{id:'" + id + "'}",
            contentType: "application/json; charset=utf-8",
            datatype: "jsondata",
            async: "true",
...
function deleteSelected(idList) {
    ...
    $.ajax({
        type: "POST",
        url: "WebServices/IdeaWs.asmx/DeleteMultiRecord",
