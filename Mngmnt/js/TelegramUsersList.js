...
function LoadTelegramRegister() {

    ShowLoading();
    $.ajax({
        type: "POST",
        url: "WebServices/TelegramRegisterWs.asmx/GetData",
        data: "{}",
        ...
        success: function (response) {
            ...
            for (var i = 0; i < msg.length; i++) {
                ...
                table += '<tr>' +
                    ...
                    '<td>' + msg[i].CustomerEmail + '</td>' +
                    '<td>' + msg[i].CustomerMobile + '</td>' +
                    '<td>' + msg[i].FavoriteContent + '</td>' +
...
function deleteRecord(id) {
    ...
    if (ans == true) {
        $.ajax({
            type: "POST",
            url: "WebServices/TelegramRegisterWs.asmx/DeleteRecord",
            data: "{id:'" + id + "'}",
            contentType: "application/json; charset=utf-8",
            datatype: "jsondata",
            async: "true",
...
function deleteSelected(idList) {
    ...
    $.ajax({
        type: "POST",
        url: "WebServices/TelegramRegisterWs.asmx/DeleteMultiRecord",
