<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OurServiceList.aspx.cs" Inherits="Mngmnt_OurServiceList" %>
...
<head>
    ...
    <script src="js/OurServiceList.js"></script>
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">لیست سرویس ها</li>
