        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="txtMinResponse" class="form-control" placeholder="حجم">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">
                    ...
                    <div class="col-sm-9">
                        <input type="text" placeholder="حجم شبانه " id="txtDescription" class="form-control" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="txtMaxResponse" class="form-control" placeholder="سرعت">
                    </div>
                </div>                              
                <div class="form-group">
                    <label class="col-sm-2 control-label">
                    ...
                    <div class="col-sm-9">
                        <select  id="drpGroup" class="form-control"></select>
                    </div>
                </div>
                <div class="form-group">
