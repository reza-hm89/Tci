<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IdeaList.aspx.cs" Inherits="Mngmnt_IdeaList" %>
...
<head>
    ...
    <script src="js/IdeaList.js"></script>
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">لیست ایده ها</li>
