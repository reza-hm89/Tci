	...
	$.extend(theme, {
		...
		Nav: {
			...
			events: function() {
				...
				// Add Arrows
				$header.find('.dropdown-toggle, .dropdown-submenu > a').append($('<i />').addClass('icon-a-down'));

				// Mobile Arrows
				$header.find('.dropdown-toggle[href=#], .dropdown-submenu [href=#], .dropdown-toggle[href!=#] .icon-a-down, .dropdown-submenu a[href!=#] .icon-a-down').on('click', function(e) {
					e.preventDefault();
					if ($window.width() < 992) {
