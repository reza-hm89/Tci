...
{
    /// <summary>
    /// Summary description for DateAndTime
    /// </summary>
    public class DateAndTime
    {
        ...
        public string PersianDate(DateTime Mdate)
        {
            ...
            string date = string.Format(" {2}/{1}/{0}", ps.GetDayOfMonth(Mdate).ToString("00"),

                ps.GetMonth(Mdate).ToString("00"), ps.GetYear(Mdate));
            return date;
        }
    ...
    public class MaftooxCalendar
    {
        /// <summary>
        /// برای کار کردن با تقویم  هجری شمسی
        /// </summary>
        public class MaftooxPersianCalendar
        {
            public struct PDate
            {
                public int year;
        ...
        /// </summary>
        public class MaftooxNumberToPersianText
        {
